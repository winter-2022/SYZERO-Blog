<template>
  <d2-container>
    ...
    <el-header>
      <el-row :gutter="20">
        <el-col :span="17"
          ...
          <el-button @click="delRow" type="danger">批量删除</el-button></el-col
        >
        <el-col :span="3"
          ><el-cascader
            :options="cateOptions"
    ...
    >
      ...
      <el-table-column prop="createUserName" label="作者"> </el-table-column>
      <el-table-column prop="createTime" label="时间"> </el-table-column>
      <el-table-column prop="commentNums" label="评论数"> </el-table-column>
      <el-table-column prop="viewNums" label="查看次数"> </el-table-column>
      <el-table-column label="操作" width="145" align="center">
        <template slot-scope="scope">
          ...
          <el-button
            size="mini"
            type="danger"
            @click="handleRowRemove(scope.$index, scope.row)"
            >删除</el-button
          >
        </template>
      </el-table-column>
