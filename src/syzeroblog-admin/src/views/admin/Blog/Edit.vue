    ...
    <el-row>
      <el-col :span="18">
        ...
        <el-form :model="data.form">
          ...
          <el-form-item label="内容" :label-width="data.formLabelWidth">
            <d2-mde v-model="data.form.content" :config="data.config" />
          </el-form-item>
          <el-form-item label="摘要" :label-width="data.formLabelWidth">
      ...
      <el-col :span="6">
        <el-form :model="data.form">
          ...
          <el-form-item label="状态" :label-width="data.formLabelWidth">
            <el-select
          ...
          <el-form-item label="模板" :label-width="data.formLabelWidth">
            <el-input
              v-model="data.form.template"
              autocomplete="off"
            ></el-input>
          </el-form-item>
          <el-form-item label="标签" :label-width="data.formLabelWidth">
            <el-select
          ...
          <el-form-item label="发布时间" :label-width="data.formLabelWidth">
            <el-date-picker
          ...
          <el-form-item label="别名" :label-width="data.formLabelWidth">
            <el-input v-model="data.form.alias" autocomplete="off"></el-input>
          </el-form-item>
          <el-form-item label="排序" :label-width="data.formLabelWidth">
            <el-input-number
              v-model="data.form.order"
              :min="0"
            ></el-input-number>
          </el-form-item>
          <el-form-item label="是否顶置" :label-width="data.formLabelWidth">
            <el-switch v-model="data.form.isTop" active-color="#13ce66">
            </el-switch>
          </el-form-item>
        </el-form>
      </el-col>
